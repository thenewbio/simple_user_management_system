                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url($user->id . '/') }}" title="Delete Student"><button class="ml-4 bg-red-500 tracking-wide text-white px-6 py-2 inline-block mb-6 shadow-lg rounded hover:shadow"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Delete</button></a>
